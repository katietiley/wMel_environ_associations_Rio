...
**4. Run sensitivity analyses**  
    ...
    4. mulitnomial_gam_sensitivity_force_favelas.Rmd  
    5. mulitnomial_gam_sensitivity_force_vegetation.Rmd  
    6. multinomial_gam_sensitivity_building_height_definition.Rmd  
    7. multinomial_gam_sensitivity_favela_by_elevation.Rmd  
  
**Note:** The scripts are intended to be run sequentially, as intermediate objects generated in earlier steps are used by subsequent analyses. All required data is included in this repo.  
